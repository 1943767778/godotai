...
[color=white][b]🤖 Gamedev AI 插件加载成功！[/b][/color]

集成到 Godot 4 的智能助手。可以自动构建系统、重构脚本、实时调试你的游戏。

[color=yellow][b]🛠️ 快速上手：[/b][/color]
 • [b]聊天与构建：[/b] 让 AI 创建机制，或者拖拽文件 / 节点给它。
 • [b]审阅改动：[/b] 使用 Diff 预览安全地接受或跳过 AI 的代码。
 • [b]观察模式：[/b] 开启后 AI 会自动修复控制台错误。

[color=yellow][b]🔗 联系作者：[/b][/color]
 💬 [url=https://qm.qq.com/q/275TmvavSY]QQ: 1943767778[/url]
[color=cyan][b]========================================================================[/b][/color]
"""
	print_rich(banner)
